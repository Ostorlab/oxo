...
def testScannerConfigFromJson_whenReceivingConfApiResponse_shouldCreateConfInstance() -> None:
    ...
    scanner_conf_instance = scanner_conf.ScannerConfig.from_json(config=api_response_data)
