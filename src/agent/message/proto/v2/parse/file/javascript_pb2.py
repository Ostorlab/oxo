...
_JAVASCRIPT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name='scan_id', full_name='javascript.scan_id', index=0,
        ...
        _descriptor.FieldDescriptor(
            name='filename', full_name='javascript.filename', index=1,
            ...
            serialized_options=None, file=DESCRIPTOR),
        _descriptor.FieldDescriptor(
            name='filecontent', full_name='javascript.filecontent', index=2,
...
javascript = _reflection.GeneratedProtocolMessageType('javascript', (_message.Message,), dict(
    ...
    __module__='javascript_pb2'
    # @@protoc_insertion_point(class_scope:javascript)
))
