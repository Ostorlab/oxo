...
# source: v3/report/screenshot/screenshot.proto
...
_MESSAGE = _descriptor.Descriptor(
  name='Message',
  full_name='v3.report.screenshot.Message',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='content', full_name='v3.report.screenshot.Message.content', index=0,
...
Message = _reflection.GeneratedProtocolMessageType('Message', (_message.Message,), dict(
  DESCRIPTOR = _MESSAGE,
  __module__ = 'v3.report.screenshot.screenshot_pb2'
  # @@protoc_insertion_point(class_scope:v3.report.screenshot.Message)
  ))
