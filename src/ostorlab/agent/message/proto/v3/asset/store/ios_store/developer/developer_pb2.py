...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'ostorlab/agent/message/proto/v3/asset/store/ios_store/developer/developer.proto'
)
...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'ostorlab.agent.message.proto.v3.asset.store.ios_store.developer.developer_pb2', _globals)
