...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    0,
    '',
    'ostorlab/agent/message/proto/v3/asset/store/ios_store/ios_store.proto'
)
...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'ostorlab.agent.message.proto.v3.asset.store.ios_store.ios_store_pb2', _globals)
