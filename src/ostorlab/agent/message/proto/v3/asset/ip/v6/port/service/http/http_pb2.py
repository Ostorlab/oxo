...
# source: v3/asset/ip/v6/port/service/http/http.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='v3/asset/ip/v6/port/service/http/http.proto',
...
_MESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='banner', full_name='v3.asset.ip.v6.port.service.Message.banner', index=7,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='tls', full_name='v3.asset.ip.v6.port.service.Message.tls', index=8,
...
Message = _reflection.GeneratedProtocolMessageType('Message', (_message.Message,), {
  'DESCRIPTOR' : _MESSAGE,
  '__module__' : 'v3.asset.ip.v6.port.service.http.http_pb2'
