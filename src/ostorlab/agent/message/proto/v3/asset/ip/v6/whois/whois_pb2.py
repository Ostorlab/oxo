...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'ostorlab/agent/message/proto/v3/asset/ip/v6/whois/whois.proto'
)
...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'ostorlab.agent.message.proto.v3.asset.ip.v6.whois.whois_pb2', _globals)
