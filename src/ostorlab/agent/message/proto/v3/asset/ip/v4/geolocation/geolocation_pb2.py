...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    0,
    '',
    'ostorlab/agent/message/proto/v3/asset/ip/v4/geolocation/geolocation.proto'
)
...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'ostorlab.agent.message.proto.v3.asset.ip.v4.geolocation.geolocation_pb2', _globals)
