...
# source: v3/asset/ip/v4/port/port.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='v3/asset/ip/v4/port/port.proto',
...
_MESSAGE = _descriptor.Descriptor(
  name='Message',
  full_name='v3.asset.ip.v4.port.Message',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='mask', full_name='v3.asset.ip.v4.port.Message.mask', index=1,
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='protocol', full_name='v3.asset.ip.v4.port.Message.protocol', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='state', full_name='v3.asset.ip.v4.port.Message.state', index=5,
...
Message = _reflection.GeneratedProtocolMessageType('Message', (_message.Message,), dict(
  DESCRIPTOR = _MESSAGE,
  __module__ = 'v3.asset.ip.v4.port.port_pb2'
  # @@protoc_insertion_point(class_scope:v3.asset.ip.v4.port.Message)
  ))
