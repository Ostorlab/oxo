...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=b'\n>ostorlab/agent/message/proto/v3/asset/file/source/source.proto\x12*ostorlab.agent.message.proto.v3.asset.file\":\n\x07Message\x12\x0f\n\x07\x63ontent\x18\x01 \x01(\x0c\x12\x0c\n\x04path\x18\x02 \x01(\t\x12\x10\n\x08language\x18\x03 \x01(\t'
)
...
_MESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='language', full_name='ostorlab.agent.message.proto.v3.asset.file.Message.language', index=2,
