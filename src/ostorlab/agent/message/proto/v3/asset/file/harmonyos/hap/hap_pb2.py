...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'ostorlab/agent/message/proto/v3/asset/file/harmonyos/hap/hap.proto'
)
...
_builder.BuildTopDescriptorsAndMessages(DESCRIPTOR, 'ostorlab.agent.message.proto.v3.asset.file.harmonyos.hap.hap_pb2', _globals)
