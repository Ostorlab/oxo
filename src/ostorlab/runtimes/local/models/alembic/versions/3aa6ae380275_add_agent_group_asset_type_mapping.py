...
def upgrade() -> None:
    ...
    op.create_table('agent_group_asset_type',
    sa.Column('agent_group_id', sa.Integer(), nullable=False),
    sa.Column('asset_type_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['agent_group_id'], ['agent_group.id'], name=op.f('fk_agent_group_asset_type_agent_group_id_agent_group')),
    sa.ForeignKeyConstraint(['asset_type_id'], ['asset_type.id'], name=op.f('fk_agent_group_asset_type_asset_type_id_asset_type')),
    sa.PrimaryKeyConstraint('agent_group_id', 'asset_type_id', name=op.f('pk_agent_group_asset_type'))
    )
