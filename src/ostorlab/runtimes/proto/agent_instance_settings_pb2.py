...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto2',
  serialized_pb=_b('\n\x1d\x61gent_instance_settings.proto\x12\x17ostorlab.runtimes.proto\"0\n\x03\x41rg\x12\x0c\n\x04name\x18\x01 \x02(\t\x12\x0c\n\x04type\x18\x02 \x02(\t\x12\r\n\x05value\x18\x03 \x02(\x0c\"<\n\x0bPortMapping\x12\x13\n\x0bsource_port\x18\x01 \x02(\x11\x12\x18\n\x10\x64\x65stination_port\x18\x02 \x02(\x11\"\xcd\x02\n\x15\x41gentInstanceSettings\x12\x0f\n\x07\x62us_url\x18\x01 \x02(\t\x12\x1a\n\x12\x62us_exchange_topic\x18\x02 \x02(\t\x12*\n\x04\x61rgs\x18\x03 \x03(\x0b\x32\x1c.ostorlab.runtimes.proto.Arg\x12\x13\n\x0b\x63onstraints\x18\x04 \x03(\t\x12\x0e\n\x06mounts\x18\x05 \x03(\t\x12\x16\n\x0erestart_policy\x18\x06 \x02(\t\x12\x11\n\tmem_limit\x18\x07 \x01(\x12\x12\x38\n\nopen_ports\x18\x08 \x03(\x0b\x32$.ostorlab.runtimes.proto.PortMapping\x12\x10\n\x08replicas\x18\t \x02(\x11\x12\x18\n\x10healthcheck_host\x18\n \x02(\t\x12\x18\n\x10healthcheck_port\x18\x0b \x02(\x11\x12\x0b\n\x03key\x18\x0c \x02(\t')
)
...
_AGENTINSTANCESETTINGS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='bus_url', full_name='ostorlab.runtimes.proto.AgentInstanceSettings.bus_url', index=0,
      number=1, type=9, cpp_type=9, label=2,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='bus_exchange_topic', full_name='ostorlab.runtimes.proto.AgentInstanceSettings.bus_exchange_topic', index=1,
      number=2, type=9, cpp_type=9, label=2,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='args', full_name='ostorlab.runtimes.proto.AgentInstanceSettings.args', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='constraints', full_name='ostorlab.runtimes.proto.AgentInstanceSettings.constraints', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='mounts', full_name='ostorlab.runtimes.proto.AgentInstanceSettings.mounts', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='restart_policy', full_name='ostorlab.runtimes.proto.AgentInstanceSettings.restart_policy', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='mem_limit', full_name='ostorlab.runtimes.proto.AgentInstanceSettings.mem_limit', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='open_ports', full_name='ostorlab.runtimes.proto.AgentInstanceSettings.open_ports', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='replicas', full_name='ostorlab.runtimes.proto.AgentInstanceSettings.replicas', index=8,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='healthcheck_host', full_name='ostorlab.runtimes.proto.AgentInstanceSettings.healthcheck_host', index=9,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='healthcheck_port', full_name='ostorlab.runtimes.proto.AgentInstanceSettings.healthcheck_port', index=10,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='key', full_name='ostorlab.runtimes.proto.AgentInstanceSettings.key', index=11,
