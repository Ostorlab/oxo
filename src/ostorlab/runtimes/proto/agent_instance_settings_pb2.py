...
_AGENTINSTANCESETTINGS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='tracing_collector_url', full_name='ostorlab.runtimes.proto.AgentInstanceSettings.tracing_collector_url', index=15,
...
AgentInstanceSettings = _reflection.GeneratedProtocolMessageType('AgentInstanceSettings', (_message.Message,), {
