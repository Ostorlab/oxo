...
from ostorlab.cli.ci_scan.run.ci_logger import console_logger, github_logger, circleci_logger, logger
...
CI_LOGGER = {"console": console_logger.Logger, "github": github_logger.Logger, "circleci": circleci_logger.Logger}
